...
public class Game {
    ...
    public String checkGameWinner(char[][] grid) {
        ...
        // X WIN
        if (String.valueOf(grid[0][0]).equals("x") && (grid[0][0] == grid[1][0] && grid[1][0] == grid[2][0])) {
            result = "X Win";
        } else if (String.valueOf(grid[0][1]).equals("x") && (grid[0][1] == grid[1][1] && grid[1][1] == grid[2][1])) {
            result = "X Win";
        } else if (String.valueOf(grid[0][2]).equals("x") && (grid[0][2] == grid[1][2] && grid[1][2] == grid[2][2])) {
            result = "X Win";
        } else if (String.valueOf(grid[0][0]).equals("x") && (grid[0][0] == grid[1][1] && grid[1][1] == grid[2][2])) {
            result = "X Win";
        } else if (String.valueOf(grid[0][2]).equals("x") && (grid[0][2] == grid[1][1] && grid[1][1] == grid[2][0])) {
            result = "X Win";
        } else if (String.valueOf(grid[0][0]).equals("x") && (grid[0][0] == grid[0][1] && grid[0][1] == grid[0][2])) {
            result = "X Win";
        } else if (String.valueOf(grid[1][0]).equals("x") && (grid[1][0] == grid[1][1] && grid[1][1] == grid[1][2])) {
            result = "X Win";
        } else if (String.valueOf(grid[2][0]).equals("x") && (grid[2][0] == grid[2][1] && grid[2][1] == grid[2][2])) {
            result = "X Win";
        }

        // O WIN
        if (String.valueOf(grid[0][0]).equals("o") && (grid[0][0] == grid[1][0] && grid[1][0] == grid[2][0])) {
            result = "O Win";
        } else if (String.valueOf(grid[0][1]).equals("o") && (grid[0][1] == grid[1][1] && grid[1][1] == grid[2][1])) {
            result = "O Win";
        } else if (String.valueOf(grid[0][2]).equals("o") && (grid[0][2] == grid[1][2] && grid[1][2] == grid[2][2])) {
            result = "O Win";
        } else if (String.valueOf(grid[0][0]).equals("o") && (grid[0][0] == grid[1][1] && grid[1][1] == grid[2][2])) {
            result = "O Win";
        } else if (String.valueOf(grid[0][2]).equals("o") && (grid[0][2] == grid[1][1] && grid[1][1] == grid[2][0])) {
            result = "O Win";
        } else if (String.valueOf(grid[0][0]).equals("o") && (grid[0][0] == grid[0][1] && grid[0][1] == grid[0][2])) {
            result = "O Win";
        } else if (String.valueOf(grid[1][0]).equals("o") && (grid[1][0] == grid[1][1] && grid[1][1] == grid[1][2])) {
            result = "O Win";
        } else if (String.valueOf(grid[2][0]).equals("o") && (grid[2][0] == grid[2][1] && grid[2][1] == grid[2][2])) {
            result = "O Win";
        }
